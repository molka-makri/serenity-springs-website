...
<html lang="en">
  <head>
    ...
    <style>
/* Style de la conteneur des cartes */
.card-container {
    display: flex;
    flex-wrap: wrap;
...
/* Style des cartes */
.card {
    width: 300px; /* Largeur fixe pour des cartes uniformes */
...
<div class="container mt-5">
    ...
    if (!empty($organizers)) {
        ...
        foreach ($organizers as $organizer) {
            ...
            // Bouton Edit
            echo "<button class='btn btn-secondary btn-edit' onclick=\"showEditForm('" . $organizer['Organizer_id'] . "', '" . $organizer['Organizer_name'] . "', '" . $organizer['Organizer_email'] . "')\">Edit</button>";
