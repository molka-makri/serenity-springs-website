...
<h4 style="color: #00796b;">Frontend: HTML, CSS, JavaScript</h4>

<h4 style="color: #00796b;">Backend: PHP</h4>

<h4 style="color: #00796b;">Integrations: Weather API, Chatbot platform (custom),Email Vendor</h3>
</div>
